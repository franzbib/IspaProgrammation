...
// Thèmes pour A2→B1
const themesA2B1 = [
  "LES LOISIRS", "LA GASTRONOMIE", "LA LITTÉRATURE", "LES ÉTUDES SUPÉRIEURES",
  "RÉUSSIR SA CANDIDATURE", "LE CINÉMA", "LE SPORT", "LA SANTÉ",
  "LES MÉDECINES ALTERNATIVES", "LE COMMERCE ET L'ÉCONOMIE", "LE TOURISME", "LE LOGEMENT",
  "L'ÉCOLOGIE", "LES TRANSPORTS PROPRES", "LA VIE ASSOCIATIVE", "LIBERTÉ, ÉGALITÉ, FRATERNITÉ",
  "LA PARITÉ", "LES GRANDS REPÈRES HISTORIQUES", "LE SYSTÈME POLITIQUE", "LE MONDE NUMÉRIQUE",
  "LES MÉDIAS", "L'ANALYSE D'UNE ŒUVRE D'ART", "LA MÉTÉO ET LE CHANGEMENT CLIMATIQUE", "LE MONDE PROFESSIONNEL",
  "LES CLICHÉS", "L'ENQUÊTE", "LA MUSIQUE", "LE SYSTÈME SCOLAIRE",
  "LA MODE", "L'ACCÈS À LA CULTURE"
];

// Points grammaticaux pour A2→B1
const grammarPointsA2B1 = [
  "Présent de l'indicatif (rappel et consolidation)",
  "Futur proche (plans, projets de loisirs)",
  "Prépositions de lieu et de temps",
  "Articles définis / indéfinis / partitifs",
  "Expressions quantitatives (beaucoup de, un peu de…)",
  "Adjectifs qualificatifs : accord et placement",
  "Passé composé (récits brefs, lectures récentes)",
  "Imparfait (description d'ouvrages, de personnages)",
  "Différence imparfait / passé composé",
  "Pronoms personnels sujets et compléments COD",
  "Pronoms COI",
  "Pronom ON (emploi général, vie étudiante)",
  "Discours indirect au présent (rapporter questions d'entretien)",
  "Formes interrogatives (est-ce que, inversion, intonation)",
  "Pronoms toniques (moi, toi, vous dans les entretiens)",
  "Pronoms relatifs simples (qui, que, où, dont)",
  "Conjonctions de coordination (et, mais, ou, donc)",
  "Connecteurs temporels (d'abord, ensuite, enfin)",
  "Adverbes de fréquence et d'intensité",
  "Comparatif et superlatif (plus rapide que, le meilleur joueur)",
  "Pronoms EN (quantité, répétition : « j'en fais »)",
  "Impératif (donner des conseils, ordres : prends ce médicament)",
  "Négation (ne… pas, ne… jamais, ne… plus)",
  "Pronoms Y (localisation, substitution : « j'y vais »)",
  "Conjonctions de subordination (parce que, quand, si)",
  "Structures causales (car, puisque)",
  "Conditionnel présent (exprimer des conseils, hypothèses)",
  "Connecteurs logiques de cause et conséquence (donc, par conséquent)",
  "Comparatif quantitatif (plus cher que, autant de…)",
  "Expression de la quantité (peu de, beaucoup de)",
  "Futur simple (projets de voyage)",
  "Futur antérieur (notion d'anticipation simple)",
  "Prépositions de lieu détaillées (à, en, dans, chez, sur, sous)",
  "Lexique et usage de il y a vs c'est",
  "Adjectifs indéfinis et pronoms indéfinis (chaque, certains, plusieurs)",
  "Pronoms démonstratifs (celui-ci, celle-là, ceux-là)",
  "Discours indirect au passé (rapporter un débat sur l'environnement)",
  "Concordance des temps (dans hypothèses écologiques)",
  "Conditionnel passé (conséquences non réalisées)",
  "Gérondif (en + participe présent : « en conduisant »)",
  "Participe présent / adjectif verbal (polluant vs en polluant)",
  "Expressions de but (pour, afin de)",
  "Accord du participe passé avec avoir et COD placé avant",
  "Accord du participe passé avec être",
  "Voix passive (les bénévoles sont recrutés par l'association)",
  "Subjonctif présent (il faut que, bien que)",
  "Négation complexe (ne… que, ne… aucun)",
  "Structures emphatiques (c'est… qui / c'est… que)",
  "Pronoms relatifs composés (lequel, auquel, duquel)",
  "Connecteurs d'opposition (cependant, pourtant, alors que)",
  "Plus-que-parfait (antériorité dans le passé)",
  "Narration au passé : imparfait + passé composé + plus-que-parfait"
];
